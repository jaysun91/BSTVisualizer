...
void Node::hoverEnterEvent(QGraphicsSceneHoverEvent *event) {
   // scale(hoverScaleFactor, hoverScaleFactor);
    ...
    /*
     qDebug() << "parent: " << (parent() ? parent()->value() : 0)
     << "\tleft: " << (m_leftChild ? m_leftChild->value() : 0)
     << "\tright: " << (m_rightChild ? m_rightChild->value() : 0)
     << "\tsubTreeSize: " << m_subTreeSize;
     */
}
...
//  qDebug() << "update subTreeSize: " << m_value;
